    ...
    return (
        <div className="container-content">
            ...
            {article.id === 1 && <>
                ...
                <p>Como cada regra tem a sua particularidade, o segurado vai compor os requisitos em diferentes momentos, o que vai impactar, sobretudo, no valor da aposentadoria e na data de inicio do seu pagamento.
                    Aí entra a importância de realização de um <b>planejamento previdenciário, para se alcançar a concessão da melhor aposentadoria.</b></p>
            ...
            {article.id === 2 && <>
                ...
                <p>Nessa regra seria necessário, tanto para homens, quanto para mulheres, o tempo mínimo de 15 anos de contribuição.
                    A diferença entre homens e mulheres é exclusivamente em relação à idade.
                    Os homens devem ter cumulativamente os 15 anos de contribuição mínimos, com idade mínima de 65 anos. Já em relação às mulheres, a idade é progressiva, sendo acrescido 6 meses a cada ano após a reforma. Dessa forma, como em 2020 a idade mínima era de 60 anos e seis meses, em 2021, mudou para 61 anos de idade, e agora, em 2020 a idade mínima para as mulheres é de 61 anos e seis meses.</p>
